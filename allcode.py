...
board_mac = "DC:A6:32:C3:76:93"#"11:22:33:44:55:66"
start_session = False
parse_json = ''
arr_mac = []
arr_child_id = []
...
def set_default():
    global parse_json,arr_mac,arr_child_id,white_list,scan_record,incar#,arr_recheck_mac
    parse_json = ''
    arr_mac = []
    arr_child_id = []
    #arr_recheck_mac = []
...
def post_latlon_rpm(lat,lon,speed,state = 2):
    ...
    response_API = requests.post(
        ...
        json={'state_id':state,
              ...
              'speed':speed})
    print('post check in ',response_API.status_code)
...
def main():
    ...
    while start_session:
        ...
        check_out()
        print("Check session beforn send lat lon")
        check_session()
        if start_session:
            ('sending lat lon')
